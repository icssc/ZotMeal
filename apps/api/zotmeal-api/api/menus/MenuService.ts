...
// import type { ItemInfo, MenuInfo, Nutrition, StationInfo } from '../../../../../packages/shared/lib/zotmeal';

// import type { DataSnapshot, Database } from 'firebase-admin/database';

// import axios, { AxiosError } from 'axios';
// import { db } from '../firebase';
// import { DiningLocationToID, Menu, MenuParams } from './models';
...
//   public async getMenu({ location, date, meal }: MenuParams): Promise<Menu> {
//     if (!this.isValidMealPeriod(meal)) {
//       throw new InvalidMealError('invalid meal period');
//     }

//     // const cachedMenu = await this.getMenuFromDB({ location, date, meal });
...
//   private async updateDBMenu({ location, date, mealPeriod }: MenuParams): Promise<void> {
//     const menuPath = `menus/${location}/${date}/${mealPeriod}`;

//     await this.db.ref(menuPath).push();
//   }

//   private async getMenuFromDB({ location, date, mealPeriod }: MenuParams): Promise<StationInfo[]> {
...
//   public async getMenuFromCampusDish({ location, date, mealPeriod }: MenuParams): Promise<StationInfo[]> {
...
//   getCampusDishMenuUrl({ location, date, mealPeriod }: MenuParams): string {
...
// export default new MenuService('https://uci-campusdish-com.translate.goog/api/menu/GetMenus', db);
