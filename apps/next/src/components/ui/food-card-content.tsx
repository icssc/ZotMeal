...
const FoodCardContent = React.forwardRef<
  HTMLDivElement, 
  FoodCardProps
>(({ title, info, hallInfo, imgSrc, alt, rating, numRatings, ...props }, ref) => { // Destructure all needed props
  return (
    <div ref={ref} {...props}>
...
FoodCardContent.displayName = "FoodCardContent"; // Good practice for dev tools
